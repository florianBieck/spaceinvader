<template>
  <v-container fluid fill-height align-center justify-center class="px-0 py-0">
    <v-parallax dark :src="require('../assets/icons8-rocket.svg')" style="min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;">
      <v-row align="center" justify="center">
          <v-container class="m-3 transparent">
            <v-layout align-center justify-center>
              <v-container class="text-xs-center" v-if="loading">
                <h2>Sie werden angemeldet...</h2>
                <v-progress-circular
                  :size="70"
                  :width="7"
                  color="purple"
              ...
              <v-flex md8 sm8 v-if="!loading" xs12>
                <v-card>
                  ...
                  <v-container>
                    ...
                    <v-container class="text-xs-right py-1">
                      <router-link to="/passwordreset">Passwort vergessen?</router-link>
                    </v-container>
                  ...
                  <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn class="teal white--text" v-on:click="login">Login</v-btn>
                    <v-spacer></v-spacer>
                  </v-card-actions>
                </v-card>
              </v-flex>
